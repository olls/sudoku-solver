...
def main():
    ...
    # puzzle = '000508060000700010000021970060000002009147800500000090014370000070002000020805000' # Mild s
    # puzzle = '007600002040010000850007040006051000083000760000360200070400059000020080900003400' # Mild s
    # puzzle = '000801003000020401004000070010200040000030000050008060020000500407060000800903000' # Modest s
    # puzzle = '290000040013600070600009000000070001000408000500090000000500007030001980080000012' # Mean n
    # puzzle = '150000000002000000004360007006024050000050000030190800700016400000000300000000018' # Maniac n
    # puzzle = '000080000001706800060502030047000310100000006085000720030901040009803200000050000' # Nightmare n
    # puzzle = '065000008700860400000020009040001002000207000300500070400050000001079003900000260' # n
    # puzzle = '000070940000090005300005070007400100463000000000007080800000000700000028050260000' # n
    # puzzle = '000000010400000000020000000000050407008000300001090000300400200050100000000806000' # s
    # puzzle = '000386005002100700590020000081000000060000000000008000000005000600000308000400017' # n
    # puzzle = '000409670000076900000000003000001740640000018021600000100000000004320000062904000' # n
    # puzzle = '218439675400076902006002403000201746640000128021640009100060294004320061062914007' # n
    # puzzle = '000000000000003085001020000000507000004000100090000000500000073002010000000040009' # n
    # puzzle = '050000000000040003010092600000024080007000060400810700001407056005080094000000800' # s
    # puzzle = '000070506060000000000000020000000000080200000000050307001900080705000090300000000' # n
    # puzzle = '245139786389267451671845932793452618164783529528916374432678195817594263956321840' # s
    # puzzle = '018209006300000915504030087007942060023708009900015024041000570800500001030670400' # s
